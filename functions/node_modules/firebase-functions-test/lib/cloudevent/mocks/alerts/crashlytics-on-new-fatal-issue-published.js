...
exports.alertsCrashlyticsOnNewFatalIssuePublished = void 0;
const helpers_1 = require("../helpers");
exports.alertsCrashlyticsOnNewFatalIssuePublished = {
    generateMock(cloudFunction) {
        ...
        return Object.assign(Object.assign({}, (0, helpers_1.getBaseCloudEvent)(cloudFunction)), {
            ...
            source, data: getCrashlyticsNewFatalIssueData() });
    },
    match(cloudFunction) {
        var _a;
        return ((0, helpers_1.getEventType)(cloudFunction) ===
            'google.firebase.firebasealerts.alerts.v1.published' &&
            ((_a = (0, helpers_1.getEventFilters)(cloudFunction)) === null || _a === void 0 ? void 0 : _a.alerttype) === 'crashlytics.newFatalIssue');
    },
};
function getCrashlyticsNewFatalIssueData() {
