...
exports.alertsCrashlyticsOnNewNonfatalIssuePublished = void 0;
const helpers_1 = require("../helpers");
exports.alertsCrashlyticsOnNewNonfatalIssuePublished = {
    generateMock(cloudFunction) {
        ...
        return Object.assign(Object.assign({}, (0, helpers_1.getBaseCloudEvent)(cloudFunction)), {
            ...
            source, data: getCrashlyticsNewNonfatalIssueData() });
    },
    match(cloudFunction) {
        var _a;
...
function getCrashlyticsNewNonfatalIssueData() {
