...
exports.alertsCrashlyticsOnVelocityAlertPublished = void 0;
const helpers_1 = require("../helpers");
exports.alertsCrashlyticsOnVelocityAlertPublished = {
    generateMock(cloudFunction) {
        ...
        return Object.assign(Object.assign({}, (0, helpers_1.getBaseCloudEvent)(cloudFunction)), {
            ...
            source, data: getCrashlyticsVelocityAlertData() });
    },
    match(cloudFunction) {
        var _a;
        return ((0, helpers_1.getEventType)(cloudFunction) ===
            'google.firebase.firebasealerts.alerts.v1.published' &&
            ((_a = (0, helpers_1.getEventFilters)(cloudFunction)) === null || _a === void 0 ? void 0 : _a.alerttype) === 'crashlytics.velocity');
    },
};
function getCrashlyticsVelocityAlertData() {
